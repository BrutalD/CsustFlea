...
<link rel="stylesheet" type="text/css"
	href="css/singlePleaseGoods/top.css">
<link rel="stylesheet" type="text/css"
	href="css/singlePleaseGoods/middle.css">
<link rel="stylesheet" type="text/css"
	href="css/singlePleaseGoods/bottem.css">
...
<body>
	<div class="bg">
		<div class="layout1">
			...
			<form action="ListIndexPGoods_Search.action" method="post" id="fm">
			<div class="layout21">
				<div class="l1">
					<div style="padding-top: 5px;">
						<a href="index.jsp">长理跳蚤市场</a>><a href="ListIndexPGoods_limit.action">求购</a>>搜索：<s:property value="pg.pgname" />
					</div>
				</div>
				<div class="l2">
					<div class="ll1"></div>
					<div class="ll2">
						<div>
							<div class="lll1"><div style="padding-top: 20px;">关键字:</div></div>
							<div
								style="float: left;width:195px;height:55px;">
								<div
									style="width:195px;height:31px;padding-top: 15px;">
									<input type="text"
										style="width:195px;height:31px;font-family: '黑体';font-size: 18px;"
										value="iphone" />
								</div>
							</div>
							<div class="lll2">
								<div class="ll21" onclick="submit();"></div>
							</div>
							<div class="lll3">
								<a href="">二手手机</a>&nbsp&nbsp<a href="">二手电脑</a>&nbsp&nbsp<a
									href="">iphone收购</a>&nbsp&nbsp<a href="">二手设备</a>
							</div>
						</div>
					</div>
				</div>
				<div>
				<div class="singlepleasetitle">
				 <div class="singlepleasetitle1"><s:property value="pg.pgname" /></div>
				</div>
				<div class="singlepleaseadd">
				 <div class="singlepleaseadd1">求购地区:</div>
				 <div class="singlepleaseadd2"><s:property value="user.address" /></div>
				</div>
				<div class="singlepleaseprice">
				  <div class="singlepleaseprice1">价格:</div>
				  <div class="singlepleaseprice2"><s:property value="pg.pgprice" /></div>
				</div>
				<div class="singlepleasedescb">
				 <div class="singlepleasedescb1">
				   <div class="singlepleasedescb2">介绍:</div>
				   <div class="singlepleasedescb3"><div style="line-height: 26px;word-break:break-all;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<s:property value="pg.pdescb" /></div></div>
				 
				 
				 </div>
				  
				</div>
				<div class="singlepleasepeo">
				  <div class="singlepleaseadd1">联系人:</div>
				  <div class="singlepleaseadd2"><s:property value="user.username" /></div>
				
				</div>
				<div class="singlepleasepho">
				  <div class="singlepleaseprice1">联系方式:</div>
				  <div class="singlepleaseprice2"><s:property value="user.phonenumber" /></div>
				</div>
				<div class="singlepleasetime">
				 <div class="singlepleasetime1">发布时间:&nbsp&nbsp<s:property value="pg.pgtime" /></div>
				</div>
				</div>
