	...
	<div class="bg">
		...
		<div class="trd1" style="font-family: '黑体'">
			...
			<div class="trd2">
				...
				<ul>
					<li><div id="topid2">三星GT9100</div></li>
					<li><div id="trdli1">二分钟前</div></li>
				</ul>
			</div>
			...
			<div class="trd2">
				<div style="width: 100px;height: 10px;"></div>
				<ul>
					<li><div id="topid2">不修不退</div></li>
					<li><div id="trdli1">交易成功</div></li>
				</ul>
			</div>
			...
			<div class="trd2">
				<div style="width: 100px;height: 10px;"></div>
				<ul>
					<li><div style="color: white;" id="topid2">1788元</div></li>
				</ul>
			</div>
		</div>
		...
		<div class="art_tlt">
			<div class="art1">
				<ul>
					...
					<li><a href="">1.要写边框来测试的话一般都在ie里面来测试来测试</a></li>
					<li><a href="">2.要写边框来测试的话一般都在ie里面来测试来测试</a></li>
					<li><a href="">3,要写边框来测试的话一般都在ie里面来测试来测试</a></li>
					<li><a href="">4.要写边框来测试的话一般都在ie里面来测试来测试</a></li>
					<li><a href="">5.要写边框来测试的话一般都在ie里面来测试来测试</a></li>
				</ul>
			</div>
			<div class="blk2"></div>
			<div class="weibo">
		...
		<div class="bod1">
			...
			<ul>
				<li><a href=""><img src="img/index/bodpic1.gif" /> </a>
				</li>
				<li><a href=""><img src="img/index/bodpic2.gif" /> </a>
				</li>
				<li><a href=""><img src="img/index/bodpic3.gif" /> </a>
				</li>
				<li><a href=""><img src="img/index/bodpic4.gif" /> </a>
				</li>
				<li><a href=""><img src="img/index/bodpic5.gif" /> </a>
				</li>
				<li><a href=""><img src="img/index/bodpic6.gif" /> </a>
				</li>
			</ul>
